...
`melech-consult` proofs both **Implementation & Architecture** and **Product & Ideas**:
...
**Do:**
- Use `melech-consult` whenever the user says "double check", "are you sure", or asks for a second opinion on a proposal.
